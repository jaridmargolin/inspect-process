...
module.exports = function (cmd, args) {
  return new Promise(function (resolve, reject) {
    ...
    const launchDebugger = function (debuggerUrl) {
      return resizeDebugger()
        .then(() => driver.get(debuggerUrl))
        .then(() => driver.wait(until.elementLocated(By.css('.cm-execution-line'))))
        .then(() => driver.executeScript('WebInspector.SourcesPanel.instance()._togglePause();'))
        .catch((e) => {
